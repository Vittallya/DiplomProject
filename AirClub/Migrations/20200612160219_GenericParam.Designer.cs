...
namespace AirClub.Migrations
{
    ...
    [Migration("20200612160219_GenericParam")]
    partial class GenericParam
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AirClub.Model.Db.PlaceOld", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AirClub.Model.Db.UserAction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AirClub.Model.Db.UserDbEditAction", b =>
                {
                    b.HasBaseType("AirClub.Model.Db.UserAction");
                    ...
                    b.HasDiscriminator().HasValue("UserDbEditAction");
                });

            modelBuilder.Entity("AirClub.Model.Db.UserEnterAction", b =>
                {
                    b.HasBaseType("AirClub.Model.Db.UserAction");

                    b.Property<int>("NumberOfRertyes")
                        .HasColumnType("int");

                    b.HasDiscriminator().HasValue("UserEnterAction");
                });

            modelBuilder.Entity("AirClub.Model.Db.UserTableOpenAction", b =>
                {
                    b.HasBaseType("AirClub.Model.Db.UserAction");

                    b.Property<string>("DbClassType")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("VmType")
                        .HasColumnType("nvarchar(max)");

                    b.HasDiscriminator().HasValue("UserTableOpenAction");
                });
